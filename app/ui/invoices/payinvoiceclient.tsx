  ...
  const handlePayTFC = async () => {
    ...
    try {
      ...
      if (data.success && data.paymentResponse) {
        const { payment_reference, correlation_id, estimated_payment_date } =
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <header className="mb-6">
        ...
        <p className="text-sm text-gray-500">
          Would you like to pay this invoice now? Click the button to check your
          account balances and if you have enough cleared funds available, you
          can set up your payment to your childcare provider now. Otherwise, you
          can set up a payment from your bank.
        </p>
      </header>
      ...
      <section className="mb-6 bg-white p-4 rounded-lg shadow-md lg:w-1/2">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <p>{date ? formatDateToLocal(date) : "No due date provided"}</p>
          </div>
        </div>
        <div>
          <button
          ...
          {hmrcData.cleared_funds / 100 >= amount ? (
            ...
            <>
              <div className="mt-8 mb-4">
                <p>
                  You currently have insufficient funds in your Tax-Free
                  Childcare account.
                </p>
              </div>
