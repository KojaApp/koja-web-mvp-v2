...
interface KojaVerificationEmailProps {
  loginCode?: string;
  firstName: string;
}
...
export const KojaVerificationEmail = ({
  loginCode,
}: KojaVerificationEmailProps) => (
  <Html>
    <Head />
...
KojaVerificationEmail.PreviewProps = {
  loginCode: "sparo-ndigo-amurt-secan",
} as KojaVerificationEmailProps;

export default KojaVerificationEmail;
